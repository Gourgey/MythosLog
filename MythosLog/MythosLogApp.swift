...
#if canImport(UIKit)
final class MythosLogAppDelegate: NSObject, UIApplicationDelegate {
    static let didReceiveShortcutNotification = Notification.Name("MythosLogAppDelegate.didReceiveShortcut")
...
enum HomeScreenQuickActionService {
    ...
    static func consumePendingDestinationIfNeeded() -> PendingAppDestination? {
        guard let shortcutItem = MythosLogAppDelegate.pendingShortcutItem else { return nil }
        MythosLogAppDelegate.pendingShortcutItem = nil
