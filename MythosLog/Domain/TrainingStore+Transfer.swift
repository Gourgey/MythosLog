        ...
        return TrainingExportBundle(
            ...
            stats: stats.map {
                StatExport(
                    ...
                    progressionAnchorDate: $0.progressionAnchorDate,
                    progressionAnchorLevel: $0.progressionAnchorLevel,
                    progressionAnchorBaseline: $0.progressionAnchorBaseline,
            ...
            goals: goals.map {
                GoalExport(
                    ...
                    attentionViewedAt: $0.attentionViewedAt,
                    createdAt: $0.createdAt,
                    updatedAt: $0.updatedAt,
    ...
    static func importBundle(_ bundle: TrainingExportBundle, context: ModelContext) throws {
        ...
        for exported in bundle.stats {
            ...
            let stat = StatDomain(
                ...
                progressionAnchorDate: exported.progressionAnchorDate,
                progressionAnchorLevel: exported.progressionAnchorLevel,
                progressionAnchorBaseline: exported.progressionAnchorBaseline,
        ...
        for exported in bundle.goals ?? [] {
            let goal = Goal(
                ...
                attentionViewedAt: exported.attentionViewedAt,
                createdAt: exported.createdAt,
                updatedAt: exported.updatedAt,
